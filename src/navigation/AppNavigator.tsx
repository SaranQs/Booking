    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName="Login" screenOptions={{ headerShown: false }}>
                ...
                <Stack.Screen name="MyRides" component={MyRidesScreen} options={{
                    headerShown: true, headerTransparent: true,
                    headerTitleStyle: { color: '#000' }, title: 'My Rides'
                }} />
                <Stack.Screen name="Wallet" component={WalletScreen} options={{
                    headerShown: true, headerTransparent: true,
                    headerTitleStyle: { color: '#000' }, title: 'Payments'
                }} />
                <Stack.Screen name="Settings" component={SettingsScreen} options={{
                    headerShown: true, headerTransparent: true,
                    headerTitleStyle: { color: '#000' }, title: 'Settings'
                }} />
                <Stack.Screen
                    name="Support"
